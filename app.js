const CONFIG = {
  apiUrl: "/api/nfe",
  logoUrl: "https://dcdn-us.mitiendanube.com/stores/005/667/009/themes/common/logo-1922118012-1769009009-757fb821fbae032664390fbbb9a301c71769009009-480-0.webp",
};
  ...
  statusBox.innerHTML = `
    <div class="recovery-card">
      <div class="recovery-logo">
        <img src="${CONFIG.logoUrl}" alt="Casa Terrazi">
      </div>
      <div class="recovery-message">
        <strong>Não foi possivel Recuperar sua Nota por aqui.</strong>
        <p>Por favor entre em contato com o nosso atendimento através do whatsapp <a href="https://wa.me/5521994339275" target="_blank" rel="noreferrer">(21) 99433-9275</a>.</p>
